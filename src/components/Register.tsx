    ...
    >
      <div
        ...
        style={{
          ...
          padding: "clamp(30px, 6vw, 50px) clamp(20px, 8vw, 80px)",
        }}
      >
        <div className="w-full mx-auto">
          {/* Logo */}
          <div className="flex justify-center" style={{ margin: "clamp(30px, 8vw, 70px) auto 10px" }}>
